...
![Screenshot: Alert Table](../assets/analytics/analytics-alert-widget-str.png)
...
![Screenshot: Alert Table](../assets/analytics/analytics-alert-widget-cr.png)
...
![Screenshot: Alert Table](../assets/analytics/analytics-alert-widget-di.png)
